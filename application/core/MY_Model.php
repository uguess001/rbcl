...
class MY_Model extends CI_Model
{
	...
	*/
	...
	public function get_all()
	{
       ...
       /*
        * Get By ascending or descending order
        * By SUDHIR KHADKA
        */
         function get_order_by($field,$type,$where)
        {
	...
	*/
	...
	private function _fetch_table()
	{
        ...
        */
         ...
         * Fetches the table from the pluralised model name.
         *
         * Modified By IP (should follow the following format)
         *      table name: contact
         *      model name: MContact
         *
         * @return void
        ...
        private function _fetch_table()
	{
		if ($this->table == NULL)
		{
			$class = preg_replace('/^M/', '', get_class($this));
