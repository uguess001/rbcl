...
class Admin extends Admin_Controller {
 ...
 function importExcel($filename){
      ...
      foreach ($arrayData['Sheet1'] as $key => $value) {
         ...
         if($this->db->insert_batch('tbl_agents',$data)){
    ...
    function record($cipher='null') { 
        ...
        {  
...

            {
                ...
                update_dop_user_log('has added '.$this->Magent->table_name); 
        ...
        if(isset($cipher) && intval($this->Encryption->decode($cipher))) {					
            ...
            $data_content   =  array(
                ...
                'record'        => $this->Magent->PickRecord($cipher)
        ...
        elseif(isset($cipher) && $cipher=="list") {
            ...
            $data=array(
                           ...
                           'records'     => $this->Magent->PickRecord()
