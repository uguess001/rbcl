<script type="text/javascript" src="http://www.dryicesolutions.net/projects/rbcl/application/resources/admin/plugins/ckeditor/ckeditor.js"></script> 
<div class="row">
    <div class="col-md-12">
        <div class="box">
                        ...
                        <div class="form-group">              
                            <label for="textfield" class="control-label">Image Size: 1366px×600px <p style="color: red">(Please upload gif,png,jpeg,jpg file only)</p></label>
                             <div class="col-md-12" >
                                 ...
                                 <?php   } ?>
                                  <?php if (isset($record->image) && strlen($record->image)>0) { ?>
                                        <button class="btn btn-danger" id="img-remove" type="button" style="margin-bottom: 10px;"> Remove Image</button>
                                        <?php } ?><!-- 
