  ...
  <div class="ti-content text-center">
    ...
    <div class="breadcrums">
      ...
      <ol class="list-unstyled list-inline">
        ...
        <li class="list-inline-item breadcrumb-item active" aria-current="page">Links</li>
    ...
    <div class="row">
      ...
      <div class="col-12 col-lg-9">
        ...
        <ul class="list-unstyled">
         ...
         <div class="news_date"><?=date('Y-m-d', strtotime($value->CreatedOn));?></div>

                <div class="news-list-title">

                  <h3><a href="<?=base_url().'reports/GetDetails/'.$value->id?>"> <?=$value->title?> </a> </h3>
          ...
          <div class="news-list-content">
            ...
            <a target="_blank" href="<?=base_url().'uploads/reports/'.$value->file?>"><?=isset($value->file)?$value->file:''?></a>
          ...
          <div class="button-area-readmore">
            ...
            <a class="btn btn-primary hvr-bounce-to-right" href="<?=base_url().'reports/GetDetails/'.$value->id?>">Read More <i class="fa fa-angle-right"></i></a>
