...
***********/        
        ...
        function SetDetails() {
            ...
            $this->data   = array(
                ...
                'shrawan'     => $this->input->post('shrawan'),
                'bhadra'     => $this->input->post('bhadra'),
                'ashoj'     => $this->input->post('ashoj'),
                'kartik'     => $this->input->post('kartik'),
                'mangsir'     => $this->input->post('mangsir'),
                'poush'     => $this->input->post('poush'),
                'magh'     => $this->input->post('magh'),
                'falgun'     => $this->input->post('falgun'),
                'chaitra'     => $this->input->post('chaitra'),
                'baisakh'     => $this->input->post('baisakh'),
                'jestha'     => $this->input->post('jestha'),
