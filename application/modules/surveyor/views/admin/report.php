...
<div class="box-header with-border"> 
 <h3 class="box-title"> Surveyors</h3> 
 <span class="pull-right header-btn"><a href="<?php echo base_url(); ?>admin/surveyor/record/create" class="btn btn-primary add"><i class="fa fa-plus"></i> Add </a> </span> </div>
...
<div class="row container-fluid">
    ...
    <form action="surveyor/uploadExcel" method="POST" enctype="multipart/form-data">
        <div class="col-lg-9">
            <div class="offset-lg-6 pull-right">
             ...
             <p>Please name your Excel sheet as Sheet2</p>
         </span>
         </div>
        </div>
...
foreach ($records as $key => $value) { 
    ...
    <tr>
        ...
        <td><?=$status ?></td>
        <td> 
            <a href = "<?=base_url()."admin/surveyor/record/".$this->Encryption->encode($value->id )?>"><i class="fa fa-edit"></i></a> |
            <a  onClick="return confirm('Are you sure you want to delete')" href = "<?=base_url()."admin/surveyor/delete/".$this->Encryption->encode($value->id )?>"><i class="fa fa-trash"></i></a>
        </td><?php } ?>
    </tbody>
</table>
</div>
