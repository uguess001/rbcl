...
<h3 class="box-title">Add/Edit Surveyor</h3>
...
<label>Surveyor Code</label><input type = "text" name = "code" id = "code" value = "<?php echo isset($_POST['code'])?$_POST['code']:(isset($record->code)?$record->code:'') ;?>" class="form-control">
