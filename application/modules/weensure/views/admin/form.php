<div class="box">
	<div class="box-header with-border">
		...
		<span class="pull-right">
			...
			<a href="<?php echo base_url().'weensure/'.$record->slug; ?>" target="_blank" class="btn btn-warning"><?php echo LINK_ICON_NAME; ?></a>
			<?php } ?>
			<a href="<?php echo base_url().'admin/weensure'; ?>" class="btn btn-primary"><?php echo VIEWLIST_ICON; ?></a>
		</span>
	</div>
	<div class="box-body">
		<div class="row">
