                    ...
                    <div class="col-md-3 col-lg-3">
                        <div class="form-group">
                            ...
                            <select name="category" class="form-control" id="category">
                                ...
                                <!-- <option value="0"<?php echo ( (isset($record->category) && $record->category == '0') || ( isset($_POST['category']) && $_POST['category'] == '0' )) ? 'selected' : '' ?>>Select Category</option>
                                <option value="1" <?php echo ( (isset($record->category) && $record->category == '1') || ( isset($_POST['category']) && $_POST['category'] == '1' )) ? 'selected' : '' ?>>Financial Documents</option>
                                <option value="2" <?php echo ( (isset($record->category) && $record->category == '2') || ( isset($_POST['category']) && $_POST['category'] == '2' )) ? 'selected' : '' ?>>Rules, Regulations & Act</option>
                                <option value="3" <?php echo ( (isset($record->category) && $record->category == '3') || ( isset($_POST['category']) && $_POST['category'] == '3' )) ? 'selected' : '' ?>>Forms</option>
                                <option value="4" <?php echo ( (isset($record->category) && $record->category == '4') || ( isset($_POST['category']) && $_POST['category'] == '4' )) ? 'selected' : '' ?>>Tender Documents</option>
                                <option value="5" <?php echo ( (isset($record->category) && $record->category == '5') || ( isset($_POST['category']) && $_POST['category'] == '5' )) ? 'selected' : '' ?>>Career </option> -->
                                
                                <?php
                                foreach($category as $k => $item){
                                    ?>
                                    <option value="<?php echo $item->id ?>" class="form-control" 
                                        <?php echo ( (isset($record->category) && $record->category == $item->id) ) ? 'selected' : '' ?>  >
                                        <?php
                                             echo $item->title_en 
                                        ?>
                                    </option>
                        ...
                        <div class="form-group" style="display: none">
                            ...
                            <div class="controls">
                                ...
                                <div id="<?php echo $record->id;?>">
                                 ...
                                 <a href="<?php echo base_url() . 'uploads/downloads/' . $record->file; ?>" style="margin-top: 10px;">
                        ...
                        <div class="form-group" style="">
                            ...
                            <div class="controls">
                               ...
                               <input type="text" class="form-control" id="file" name="file" value="<?php echo isset($record->file) ? $record->file : ''; ?>" readonly>
                                ...
                                <?php if (isset($record->file) && strlen($record->file)>0) { ?>
                                <div id="<?php echo $record->id;?>">   
                                  <a target="_blank" href="<?php echo $record->file; ?>" style="margin-top: 10px;">
