...
function __construct() { 
	...
	function Documents($cat_id){
         $result['content'] = $this->Mfrontdownloads->GetListContents($cat_id);
         $result['data'] = $this->Mfrontdownloads->GetList();
         $result['pagination'] =  NULL;
         $result['pagination'] =  paginate($total_rows=$this->Mfrontdownloads->TotalRows,$base_url=base_url()."downloads/documents/",$this->PageLimit);
...
// print_r($result['data']);
	...
	//retreiving the data of the fiscal_year in order to show when financial report is selected.
