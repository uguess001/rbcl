...
function __construct() { 
	...
	function index(){
		$Offset=($this->uri->segment(3) && intval($this->uri->segment(3)))?($this->uri->segment(3)):0;
         ...
         $result['content'] = $this->Mfrontreports->GetAdminListByFiscalYear($Offset,$this->PageLimit);
         $result['datalist'] = $this->Mfrontreports->GetAdminListByFiscalYear($Offset,$this->PageLimit); //for outputting list of data acc to fiscal year
