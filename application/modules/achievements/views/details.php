  ...
  <div class="ti-content text-center">
    ...
    <div class="breadcrums">
      ...
      <ol class="list-unstyled list-inline">
        ...
        <li class="list-inline-item breadcrumb-item active" aria-current="page"><a href="<?=base_url().'achievements'?>"><?php echo $this->lang->line('innder_content_achievements'); ?></a></li>
      ...
      <div class="col-12 col-lg-9">
            ...
            <div class="row">
              ...
              <div class="col-12">
			   ...
			   <div class="achievements_date"><?=date('Y-m-d', strtotime($list->CreatedOn));?></div>
                ...
                <div class="achievements-list-title">
				  ...
				  <div class="achievements-list-content">
					  ...
					  <?=isset($list->description)?$list->description:''?>
					   ...
					   <a target="_blank" href="<?=base_url().'uploads/achievements/'.$list->file?>"><?=isset($list->file)?$list->file:''?></a>

				  </div>

				  <div class="button-area-readmore" style="display:none;">

					  <a class="btn btn-primary hvr-bounce-to-right" href="#"><?php echo $this->lang->line('dor_data_list_view'); ?> <i class="fa fa-angle-right"></i></a>
            ...
            <ul class="list-unstyled gallery-list-sidebar">
              ...
              if(isset($gallery) && !empty($gallery)):
                foreach ($gallery as $value) :
                  if($a<=6):
              ?>
              <li><a href="<?=base_url().'gallery/GetDetails/'.$value->id?>"><img src="<?=base_url().'uploads/gallery/'.$value->featured?>" alt="Gallery 1"></a></li>
