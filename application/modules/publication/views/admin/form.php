...
<div class="form-group">              
        ...
        <div class="fileupload fileupload-new" data-provides="fileupload">
            ...
            <img src="<?php echo isset($record->image) ? base_url() . 'uploads/publication/' . $record->image: base_url()."application/resources/admin/img/noimage.PNG"; ?>" />
            </div>
...
<div id="<?php echo $record->id;?>">   
 <a href="<?php echo base_url() . 'uploads/publication/' . $record->file; ?>" style="margin-left: 100px;">
...
url: '<?php echo base_url(); ?>' + 'admin/publication/delete_publication_file',
