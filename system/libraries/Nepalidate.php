<?php
	...
	class CI_Nepalidate
	{
		...
		{
                        //Later Added By Bishal Lepcha<lepchaboy47@gmail.com>
                        $date = explode('-',$date);
						if(count($date)==3) {
							$yy = $date[0];
	                        $mm = $date[1];
...
//				return $this->_nep_date;
                                ...
                                //Later Added By Bishal Lepcha<lepchaboy47@gmail.com>
                                $this->_new_date = $this->_nep_date['year'].'-'.$this->_nep_date['month'].'-'.$this->_nep_date['date'];
...
//				return $this->_eng_date;
                                //Later Added By Bishal Lepcha<lepchaboy47@gmail.com>
                                $this->_new_date = $this->_eng_date['year'].'-'.$this->_eng_date['month'].'-'.$this->_eng_date['date'];
				return $this->_new_date;
